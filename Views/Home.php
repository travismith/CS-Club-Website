		...
		<div class="OutterWrapper">
			<div class="NavBar">
				<div class="ActionBar">
					<div class="ActionBarTab">
						<button onclick="ToggleMenu()" class="ActionButton ToggleMenu">
			...
			<div class="InnerWrapper">
				...
				<script>
					...
					const Content = document.querySelector('div.SelectionContent');
					const Button = document.querySelector("button.ToggleMenu");
					...
					function OpenMenu()
					{
						if (MenuWidth < 20)
						{
							...
							Content.style.width = (100 - MenuWidth) + "vw";
